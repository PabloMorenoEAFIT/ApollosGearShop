@if ($paginator->hasPages())
    <style>
        ...
        .pagination-links {
            ...
            justify-content: center;
            align-items: center;
            gap: 8px;  /* Adjust spacing between pagination items */
        }

        .pagination-info {
            display: flex;
            justify-content: center;
            margin-bottom: 10px; /* Add space above the pagination buttons */
        }
    </style>
    ...
    <nav role="navigation" aria-label="{{ __('Pagination Navigation') }}" class="pagination-container">
        ...
        <div class="pagination-content">
            <div class="pagination-links">
                ...
                @else
                    <span class="relative inline-flex items-center px-4 py-2 text-sm font-medium text-gray-500 bg-white border border-gray-300 cursor-default leading-5 rounded-r-md dark:text-gray-600 dark:bg-gray-800 dark:border-gray-600">
                        {!! __('pagination.next') !!}
                    </span>
                @endif
            </div>
