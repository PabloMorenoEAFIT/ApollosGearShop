...
<div class="mb-4 d-flex justify-content-center">
    <form method="GET" action="{{ route('admin.instrument.index') }}">
        <div class="row">
            <div class="col-md-3">
    ...
    <div class="col-md-4 col-lg-3 mb-3">
        <div class="card h-100 shadow-sm">
            ...
            <div class="card-body text-center">
                ...
                <!-- Details Button -->
                <a href="{{ route('admin.instrument.show', ['id'=>  $instrument->getId()]) }}" class="btn btn-primary">
                    {{ __('messages.details') }}
                </a>
            </div>
        </div>
    ...
    <div class="col-md-4 col-lg-3 mb-2">
        <div class="card">
            ...
            <div class="card-body text-center">
                ...
                <a href="{{ route('admin.instrument.show', ['id'=>  $instrument->getId()]) }}"
