<div class="card mt-4">
    ...
    <div class="card-body">
        <div class="row d-flex align-items-stretch">
            <div class="col">
                <!-- Form to Add Stock -->
                <form action="{{ route('admin.stock.add', $viewData["stock"]->getId()) }}" method="POST">
                    @csrf
            ...
            <div class="col">
                <!-- Form to Lower Stock -->
                <form action="{{ route('admin.stock.lower', $viewData["stock"]->getId()) }}" method="POST">
                    @csrf
                    <div class="form-group">
...
<div class="row mt-4 mx-auto">
    <div class="col d-flex justify-content-center">
        ...
        <form action="{{ route('admin.stock.delete', $viewData["stock"]->getId()) }}" method="POST">
            @csrf
            @method('DELETE')
