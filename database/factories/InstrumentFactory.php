...
class InstrumentFactory extends Factory
{
    ...
    public function definition(): array
    {
        ...
        return [
            ...
            'quantity' => $this->faker->numberBetween(1, 20), // Optional: If quantity is redundant, remove
    ...
    public function withStock(int $stockQuantity = 10): static
    {
        return $this->afterCreating(function (Instrument $instrument) use ($stockQuantity) {
